                ...
                <form action="<?php t(MAIN_FILE) ?>/admin/gallery_form<?php $_view['entry']['id'] ? t('?id=' . $_view['entry']['id']) : '' ?>" method="post" class="register validate">
                    ...
                    <div class="card shadow-sm mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                <label class="fw-bold">コード <span class="badge text-bg-secondary" data-bs-toggle="tooltip" title="ギャラリーのURLに使用されます。">？</span> <span class="badge text-bg-danger">必須</span></label>
