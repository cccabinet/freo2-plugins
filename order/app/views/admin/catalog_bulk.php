    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 mb-2 px-md-4">
        ...
        <div class="card shadow-sm mb-3">
            ...
            <?php if (empty($_view['entries'])) : ?>
                ...
                <p><a href="<?php t(MAIN_FILE) ?>/admin/catalog" class="btn btn-secondary px-4" role="button">戻る</a></p>
            <?php else : ?>
                <p>以下の商品が削除されます。よろしければ削除ボタンを押してください。</p>
                ...
                <form action="<?php t(MAIN_FILE) ?>/admin/catalog_delete" method="post" class="delete">
                    ...
                    <div class="form-group my-4">
                        <a href="<?php t(MAIN_FILE) ?>/admin/catalog" class="btn btn-secondary px-4" role="button">戻る</a>
