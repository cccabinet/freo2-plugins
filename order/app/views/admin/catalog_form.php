    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 mb-2 px-md-4">
        ...
        <div class="card shadow-sm mb-3">
            ...
            <?php else : ?>
                ...
                <form action="<?php t(MAIN_FILE) ?>/admin/catalog_form<?php $_view['entry']['id'] ? t('?id=' . $_view['entry']['id']) : '' ?>" method="post" class="register validate">
                    ...
                    <div class="card shadow-sm mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea name="text" rows="10" cols="50" class="form-control<?php if ($GLOBALS['plugin']['order']['setting']['text_type'] === 'wysiwyg') : ?> editor<?php endif ?>"><?php t($_view['entry']['text']) ?></textarea>
                            </div>
                            <?php endif ?>
                            <?php if ($GLOBALS['plugin']['order']['setting']['text_type'] === $_view['entry']['text_type']) : ?>
                            ...
                            <?php endif ?>
                            <?php if ($GLOBALS['plugin']['order']['setting']['use_pictures']) : ?>
                            <div class="form-group mb-2">
                            ...
                            <?php endif ?>
                            <?php if ($GLOBALS['plugin']['order']['setting']['use_thumbnail']) : ?>
                            <div class="form-group mb-2">
                ...
                <?php if ($GLOBALS['plugin']['order']['setting']['use_approve'] && $GLOBALS['authority']['power'] >= 3) : ?>
                <form action="<?php t(MAIN_FILE) ?>/admin/catalog_approve" method="post" class="approve">
                    <input type="hidden" name="_token" value="<?php t($_view['token']) ?>" class="token">
                    <input type="hidden" name="id" value="<?php t($_view['entry']['id']) ?>">
                ...
                <?php endif ?>
                <form action="<?php t(MAIN_FILE) ?>/admin/catalog_delete" method="post" class="delete">
                    <input type="hidden" name="_token" value="<?php t($_view['token']) ?>" class="token">
                    <input type="hidden" name="id" value="<?php t($_view['entry']['id']) ?>">
                    <div class="card shadow-sm mb-3">
                        <div class="card-header">
