    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 mb-2 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 mb-2">
            ...
            <nav style="--bs-breadcrumb-divider: '>';">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php t(MAIN_FILE) ?>/admin/delivery">配送方法管理</a></li>
        ...
        <div class="card shadow-sm mb-3">
            ...
            <div class="card-body">
                ...
                <form action="<?php t(MAIN_FILE) ?>/admin/delivery_form<?php $_view['order_delivery']['id'] ? t('?id=' . $_view['order_delivery']['id']) : '' ?>" method="post" class="register validate">
                    <input type="hidden" name="_token" value="<?php t($_view['token']) ?>" class="token">
                    <input type="hidden" name="id" value="<?php t($_view['order_delivery']['id']) ?>">
                    <div class="card shadow-sm mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="calculate" class="form-select" style="width: 200px;">
                                    ...
                                    <option value="<?php t($key) ?>"<?php $key == $_view['order_delivery']['calculate'] ? e(' selected="selected"') : '' ?>><?php t($value) ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-group mb-2">
                                <label class="fw-bold">値引き後の送料</label>
                ...
                <form action="<?php t(MAIN_FILE) ?>/admin/delivery_delete" method="post" class="delete">
                    <input type="hidden" name="_token" value="<?php t($_view['token']) ?>" class="token">
                    <input type="hidden" name="id" value="<?php t($_view['order_delivery']['id']) ?>">
                    <div class="card shadow-sm mb-3">
                        <div class="card-header">
