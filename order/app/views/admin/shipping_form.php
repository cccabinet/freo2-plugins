                    ...
                    <div class="card shadow-sm mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-2">
                                <label class="fw-bold">商品 <span class="badge text-bg-secondary" data-bs-toggle="tooltip" title="今回発送する数を入力してください。">？</span></label>
                            ...
                            <div class="form-group mb-2">
                                <label class="fw-bold">送料 <span class="badge text-bg-secondary" data-bs-toggle="tooltip" title="この発送で実際にかかった送料。">？</span></label>
